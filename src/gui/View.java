...
public class View extends Canvas {
	...
	public void setImage(Image image, boolean disposeCurrentImage) {
		if (disposeCurrentImage && m_image != null && m_image != image) {
			m_image.dispose();
		}
		m_image = image;
		if (m_image != null) {
			m_imageData = image.getImageData();
			m_imageType = ImageProcessing.determineImageType(m_imageData);
		} else {
			m_imageData = null;
		}
		updateScrollBars();
