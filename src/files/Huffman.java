...
public class Huffman implements IImageFile {
	...
	private Node createHuffmanTree(int[] hist, Leaf[] codes, int size) {
		...
		// TODO Mittlere Codel�nge und Datei-Speicherbedarf absch�tzen (Unter- und Obergrenze) und auf der Konsole ausgeben
		System.out.println("Geschätzte mittlere Codelänge: " + (float)H +  "," + (float)(H+1));
		System.out.println("Geschätzte Speicherbedarf: " + (float)H*size/8 +  "," + (float)(H+1)*size/8 + " Byte");
